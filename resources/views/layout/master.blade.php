...
<body>
	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				{{config('app.name','Detectum')}} <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				<li>
					<a href="home.html">
						<i class="zmdi zmdi-view-dashboard zmdi-hc-fw"></i> Administrador
					</a>
				</li>
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="period.html"><i class="zmdi zmdi-timer zmdi-hc-fw"></i> Crear Usuario</a>
						</li>
						<li>
							<a href="subject.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Lista de Usuarios</a>
						</li>
						<li>
							<a href="section.html"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> roles de Usuarios</a>
						</li>
						<li>
	...
	<script src="{{ asset('lib/js/jquery-3.1.1.min.js') }}"></script>
	<script src="{{ asset('lib/js/sweetalert2.min.js') }}"></script>
	<script src="{{ asset('lib/js/bootstrap.min.js') }}"></script>
	<script src="{{ asset('lib/js/material.min.js') }}"></script>
	<script src="{{ asset('lib/js/ripples.min.js') }}"></script>
	<script src="{{ asset('lib/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
